...
public class BahayKuboHutStructure extends ScatteredStructure<NoFeatureConfig> {
	   ...
	   public BahayKuboHutStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> p_i51424_1_) {
	      super(p_i51424_1_);
	   }

	   public String getStructureName() {
	      return "Bahay_Kubo_Hut";
	   }
	   ...
	   public Structure.IStartFactory getStartFactory() {
	      return BahayKuboHutStructure.Start::new;
	   }
	   ...
	   public boolean func_202383_b(IWorld worldIn, BlockPos pos) {
	      ...
	      if (structurestart != StructureStart.DUMMY && structurestart instanceof BahayKuboHutStructure.Start && !structurestart.getComponents().isEmpty()) {
	         StructurePiece structurepiece = structurestart.getComponents().get(0);
	         return structurepiece instanceof BahayKuboHutPieces;
	      } else {
	         return false;
	      }
	   }
	   ...
	   public static class Start extends StructureStart {
	      ...
	      public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn) {
	    	  BahayKuboHutPieces hutpiece = new BahayKuboHutPieces(this.rand, chunkX * 16, chunkZ * 16);
	         this.components.add(hutpiece);
