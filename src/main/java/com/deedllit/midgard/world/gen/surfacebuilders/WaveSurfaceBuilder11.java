...
public class WaveSurfaceBuilder11 extends SurfaceBuilder<SurfaceBuilderConfig>  {
	
	private FastNoiseLite noiseLite = null ; 
	
	public WaveSurfaceBuilder11(Function<Dynamic<?>, ? extends SurfaceBuilderConfig> configFactory) {
		super(configFactory);
	}
	...
	public void buildSurface(Random random, IChunk chunkIn, Biome biomeIn, int x, int z, int startHeight, double noise,
        ...
        double sincos = Math.sin(x) * Math.cos(z) ; 
