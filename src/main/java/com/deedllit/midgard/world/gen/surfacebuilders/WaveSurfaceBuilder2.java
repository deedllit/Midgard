...
public class WaveSurfaceBuilder2 extends SurfaceBuilder<SurfaceBuilderConfig>  {

	
	public WaveSurfaceBuilder2(Function<Dynamic<?>, ? extends SurfaceBuilderConfig> configFactory) {
		super(configFactory);
	}
