...
public class WaveSurfaceBuilder7 extends SurfaceBuilder<SurfaceBuilderConfig>  {
	
	private PerlinNoiseGenerator perlinNoise = null ; 
	private SandWaves sandWaves = null ; 
	
	public WaveSurfaceBuilder7(Function<Dynamic<?>, ? extends SurfaceBuilderConfig> configFactory) {
		super(configFactory);
	}
	...
	public void buildSurface(Random random, IChunk chunkIn, Biome biomeIn, int x, int z, int startHeight, double noise,
		...
		case 1: //C 
			...
			test = Blocks.GOLD_BLOCK.getDefaultState() ; 
			break ;
		...
		case 3:  // CE
			height += this.sandWaves.getPyramid(i, j) ;
			height += this.sandWaves.getEastWestWaveHeight(i, j) ;
			test = Blocks.CUT_RED_SANDSTONE.getDefaultState() ; 
			height /= 2 ;
			break ;
		...
		case 11: //CSE (L)
			height += this.sandWaves.getCornerSouthEastWaveHeight(i, j) ;
			break ; 
			
		case 13: //CSW (L) 
			height += this.sandWaves.getCornerSouthWestWaveHeight(i, j) ;
			break ;
			
		case 19: //CNE (L) 
			height += this.sandWaves.getCornerNorthEastWaveHeight(i, j) ;
			break ;
			
		case 21: //CNW (L)
			height += this.sandWaves.getCornerNorthWestWaveHeight(i, j) ;
			break ;
		...
		case 31: //CNSEW  +  
			//CHECKED
			height += Math.max(this.sandWaves.getNorthSouthWaveHeight(i, j),  this.sandWaves.getEastWestWaveHeight(i, j))  ;
