...
public class DeltaSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderConfig>  {
	
	private FastNoiseLite noiseLite = null ; 
	
	public DeltaSurfaceBuilder(Function<Dynamic<?>, ? extends SurfaceBuilderConfig> configFactory) {
		super(configFactory);
	}
	...
	public void buildSurface(Random random, IChunk chunkIn, Biome biomeIn, int x, int z, int startHeight, double noise,
		...
		if(this.noiseLite == null) {
	        ...
	        this.noiseLite.SetFrequency(0.005f);
	        ...
	        this.noiseLite.SetCellularReturnType(CellularReturnType.Distance2Div);
