...
public class MidgardMangroveBiome extends MidgardBiome {
	...
	public MidgardMangroveBiome() {
		super((new Biome.Builder()).surfaceBuilder(SurfaceBuilderInit.MANGROVE, SurfaceBuilder.GRASS_DIRT_SAND_CONFIG)
				.precipitation(Biome.RainType.RAIN).category(Biome.Category.SWAMP).depth(-0.25F).scale(-0.0025F)
				.temperature(0.80F).downfall(0.7F).waterColor(6388580).waterFogColor(2302743).parent((String) null));
		...
		this.addFeature(GenerationStage.Decoration.SURFACE_STRUCTURES,
				FeatureInit.MANGROVE_WITCH.withConfiguration(IFeatureConfig.NO_FEATURE_CONFIG)
		...
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
				FeatureInit.MANGROVE_TREE.withConfiguration(DefaultBiomeFeatures.OAK_TREE_CONFIG).withPlacement(
