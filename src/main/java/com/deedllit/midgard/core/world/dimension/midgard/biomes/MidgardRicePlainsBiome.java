...
public class MidgardRicePlainsBiome extends MidgardBiome {

	public MidgardRicePlainsBiome() {
		super((new Biome.Builder()).surfaceBuilder(SurfaceBuilderInit.RICE_FIELD, SurfaceBuilder.GRASS_DIRT_SAND_CONFIG)
		...
		this.addWeight(MidgardClimate.TROPICAL, 3);
	}
