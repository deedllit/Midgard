...
public class MidgardDesertDune extends MidgardBiome {

	public MidgardDesertDune() {
		      super((new Biome.Builder()).surfaceBuilder(SurfaceBuilderInit.DUNE, SurfaceBuilder.SAND_SAND_GRAVEL_CONFIG)
